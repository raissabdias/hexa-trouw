...
export class TravelController {
  ...
  async create(
    ...
    return await this.createTravelUseCase.execute(body, companyId);
  }
  ...
  async findAll(
    ...
    return await this.listTravelsUseCase.execute(page, limit, companyId);
  }
  ...
  async remove(
    ...
    return await this.deleteTravelUseCase.execute(id, companyId);
  }
  ...
  async findById(
    ...
    return await this.getTravelByIdUseCase.execute(id, companyId);
  }
}
